...
import { UniqueFields } from './validadorCustom/validador-type-accounts';
...
@Module({
  ...
  providers: [BankResponse,BankService, BankAccountService,UniqueFields,IsUniqueConstraint,IsExistConstraint,ExistsBankPipe, ExistsBankAccountPipe],
  imports:[
